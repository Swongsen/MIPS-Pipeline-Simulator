...
int main(int args, char **argv){
  ...
  map<int, vector<string>> IFunit_instructions_tokened; // This should be at <0/1, instruction> mapping to tell what is in waiting/executing
